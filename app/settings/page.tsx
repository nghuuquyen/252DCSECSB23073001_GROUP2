      ...
      <div className="max-w-[480px] w-full pt-8 pb-12 px-6 sm:px-10">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-3 mb-6">
            <span className="material-symbols-outlined text-[#084C3A]" style={{ fontSize: 40, fontVariationSettings: "'FILL' 1, 'wght' 300, 'GRAD' 0, 'opsz' 24" }}>local_fire_department</span>
            <span className="text-[36px] font-black text-[#084C3A] tracking-tight" style={{ fontFamily: 'var(--font-be-vietnam-pro)' }}>CaloMate</span>
          </div>
          <h1 className="text-3xl font-bold text-[#084C3A] leading-tight">Cài đặt tài khoản</h1>
        </div>
