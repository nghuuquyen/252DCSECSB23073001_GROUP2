      ...
      <div className="max-w-[480px] sm:max-w-[520px] lg:max-w-[600px] w-full pt-8 lg:pt-10 pb-12 lg:pb-16 px-6 sm:px-10 lg:px-12">
        ...
        <div className="text-center mb-8 lg:mb-10">
          <div className="flex items-center justify-center gap-1.5 mb-6">
            ...
            <span className="text-3xl lg:text-4xl font-black text-[#084C3A]">CaloMate</span>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-7">
            ...
            <div className="grid grid-cols-3 gap-3 lg:gap-4">
              {[
                ...
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-4 lg:p-5 rounded-xl border-2 transition-all ${
                    form.goal === g.v
          ...
          <div className="relative overflow-hidden bg-[#F2F8F4] p-6 lg:p-7 rounded-2xl border border-[#E3EFE8]">
            ...
            <div className="relative z-10 mb-4">
              ...
              <div className="flex items-baseline gap-1">
                <span className="text-4xl lg:text-5xl font-black text-[#084C3A] font-numbers">
              ...
              {[
                ...
                <div key={m.label}>
                  <div className="flex items-center gap-1.5 mb-1.5">
                    ...
                    >
                      <span
                        className="material-symbols-outlined filled-icon text-[12px] lg:text-[14px]"
                        style={{ color: m.color }}
                      >
                        {m.icon}
                      </span>
                    </div>
                    <p className="text-[12px] lg:text-[13px] font-bold text-[#4A6355]">
                      {m.label}
                    </p>
                  </div>
                  <p className="text-[22px] lg:text-[26px] font-black text-[#1A2F24] font-numbers leading-none">
                    {error ? "0" : m.val}g
                  </p>
                </div>
              ))}
          ...
          <div className="pt-2">
            ...
            >
              Bắt đầu ngay <ArrowRight className="w-5 h-5 lg:w-6 lg:h-6" />
            </button>
          </div>
        </form>
      </div>
