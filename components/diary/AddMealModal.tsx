...
export default function AddMealModal({ mealType, onClose, onAdd }: AddMealModalProps) {
  ...
  return (
    <>
      ...
      {/*
        Sheet:
        Mobile  — bottom sheet, full width, bo góc trên
        Tablet+ — centered modal (md:), w-[520px], bo tất cả góc
        Laptop  — w-[600px] (lg:)
        XL      — w-[640px] (xl:)
      */}
      <div
      ...
      >
        {/* Drag handle — chỉ hiện mobile, ẩn tablet+ */}
        ...
        {/* Step 1: Food list */}
        {!selected ? (
          <div className="flex-1 overflow-y-auto px-5 lg:px-6 space-y-2 lg:space-y-2.5">
            {filtered.length === 0 && (
