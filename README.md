...
| **Sentry** | 10.53.1 | Error tracking & monitoring (NEW!) |
| **Google Analytics** | gtag 1.0.1 | User behavior tracking (NEW!) |
...
### ✅ Tracking & Monitoring Setup (Optional)

**Quick Setup for Google Analytics & Sentry:**
...
2. **Configure Environment Variables:**
   ...
   - Get Sentry DSN from [sentry.io](https://sentry.io)
   - Add to `.env.local`:
     ```
...
3. **See [TRACKING_SETUP.md](./TRACKING_SETUP.md) for detailed instructions**
